...
namespace Ryan_Debug {
	namespace macros {
		...
		template double RYAN_DEBUG_DLEXPORT m_atof(const char* x, size_t len);
		template float RYAN_DEBUG_DLEXPORT m_atof(const char* x, size_t len);

		template int RYAN_DEBUG_DLEXPORT m_atoi(const char* x, size_t len);
		//template uint64_t RYAN_DEBUG_DLEXPORT m_atoi(const char* x, size_t len);
		template unsigned long long RYAN_DEBUG_DLEXPORT m_atoi(const char* x, size_t len);
		template unsigned long RYAN_DEBUG_DLEXPORT m_atoi(const char* x, size_t len);
		template long RYAN_DEBUG_DLEXPORT m_atoi(const char* x, size_t len);
