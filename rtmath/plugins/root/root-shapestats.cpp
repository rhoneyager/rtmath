/// \brief Provides root file IO
#define _SCL_SECURE_NO_WARNINGS

#pragma warning( push )
#pragma warning( disable : 4267 ) // 'argument' : conversion from 'size_t' to 'Ssiz_t', possible loss of data
	...
	namespace registry {
		...
		*/
			...
			const rtmath::ddscat::stats::shapeFileStats *s)
		{
				...
				*/
				return sh; // Pass back the handle
		}
			...
			const rtmath::ddscat::stats::shapeFileStats *s)
		{
				...
				if (exporttype == "ar_rot_data") return export_root_ar_rot_data(sh, opts, s);
