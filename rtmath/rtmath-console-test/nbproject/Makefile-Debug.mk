...
LDLIBSOPTIONS=-lm ../rtmath-base/dist/Debug/MinGW-Windows/librtmath-base.a ../rtmath/dist/Debug/MinGW-Windows/librtmath.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rtmath-console-test.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/rtmath-console-test.exe: ../rtmath-base/dist/Debug/MinGW-Windows/librtmath-base.a
...
${OBJECTDIR}/rtmath-console-test.o: rtmath-console-test.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -Wall -MMD -MP -MF $@.d -o ${OBJECTDIR}/rtmath-console-test.o rtmath-console-test.cpp
