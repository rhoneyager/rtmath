...
#define EXPORT(U,T) \
	template void SHARED_EXPORT U(::boost::archive::xml_oarchive &, T &, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::xml_iarchive &, T &, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::text_oarchive &, T &, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::text_iarchive &, T &, const unsigned int);
...
#define EXPORTTEMPLATE(U,T,W) \
	template void SHARED_EXPORT U(::boost::archive::xml_oarchive &, W<T>&, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::xml_iarchive &, W<T>&, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::text_oarchive &, W<T>&, const unsigned int); \
	template void SHARED_EXPORT U(::boost::archive::text_iarchive &, W<T>&, const unsigned int);
