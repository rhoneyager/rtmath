...
struct sdata
{
	...
	rtmath::serialization::serialization_method defaultType;
	...
	sdata() : disableAuto(false), defaultType(rtmath::serialization::serialization_method::XML) 
...
namespace rtmath
{
	namespace serialization
	{
		...
		template bool DLEXPORT_rtmath_core detect_compressed
			(const std::string&);
		template bool DLEXPORT_rtmath_core detect_compressed
		...
		template bool DLEXPORT_rtmath_core detect_compression
		...
		template bool DLEXPORT_rtmath_core uncompressed_name
			(const std::string&, std::string&, std::string&);
		template bool DLEXPORT_rtmath_core uncompressed_name
		...
		template bool DLEXPORT_rtmath_core select_compression
			(const std::string&, std::string&);
		template bool DLEXPORT_rtmath_core select_compression
			(const boost::filesystem::path&, std::string&);

		template <typename T>
		rtmath::serialization::serialization_method select_format(const T &name, T &outname)
		{
			using std::string;
			using boost::filesystem::path;
		...
		template rtmath::serialization::serialization_method DLEXPORT_rtmath_core select_format
			(const std::string&, std::string&);
		template rtmath::serialization::serialization_method DLEXPORT_rtmath_core select_format
		...
		template bool DLEXPORT_rtmath_core known_format
			(const boost::filesystem::path &filename, const rtmath::serialization::serialization_method &meth);
		template bool DLEXPORT_rtmath_core known_format
			(const std::string &filename, const rtmath::serialization::serialization_method &meth);
