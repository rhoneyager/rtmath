...
C   ANY DAMAGES THAT MAY RESULT FROM THE USE OF THE PROGRAM. 
      ...
      subroutine tmatrix_extended() BIND(C, NAME='tmatrix_extended_')
      use, intrinsic :: ISO_C_BINDING
      IMPLICIT REAL*8 (A-H,O-Z)
      INCLUDE 'amplq.par.f'
C Using the preprocessor to handle common block definitions
#include "common.defs"
...
C  OPEN FILES *******************************************************
C TODO: change output from file to data structure?
C       or, allow for the output file to be specified and read it in
C       (easier)
      OPEN (6,FILE='test')
...
C_____________COMPUTE THETP, PHIP, THETP1, AND PHIP1, EQS. (8), (19),
C_____________AND (20)
