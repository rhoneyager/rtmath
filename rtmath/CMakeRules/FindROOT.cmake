...
IF (ROOT_FOUND)
  ...
  IF(EXISTS "${ROOT_LIBRARY_DIR_TMP}")
	...
	CACHE STRING "Path to ROOT libraries")
...
SET(ROOT_INCLUDE_DIRS ${ROOT_INCLUDE_DIR}
       CACHE STRING "Path to ROOT headers")
...
#  REMOVE_FROM_LIST(root_flags "${root_libs_all}" "${root_library}")
  ...
  MARK_AS_ADVANCED( ROOT_LIBRARY_DIR ROOT_INCLUDE_DIR ROOT_INCLUDE_DIRS ROOT_DEFINITIONS)
